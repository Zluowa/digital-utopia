  ...
  const topics: GuideDialogTopic[] = [
    {
      ...
      content: t(
        ...
        'Welcome to Digital Utopia. Use the help sections in this panel to learn how things work, then create your first task. You can re-open this help dialog or give feedback anytime from the navbar.'
      ),
    ...
    },
    {
      ...
      content: t(
        ...
        "We've automatically created a personal organization and initial project so you can get started quickly. You can also create new organizations and invite team members to collaborate."
      ),
