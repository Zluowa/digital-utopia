...
export function KanbanContainer() {
  ...
  return (
    <div className="flex flex-col h-full space-y-base">
      <div className={cn('space-y-base', isMobile ? 'px-base pt-base' : 'px-double pt-double')}>
        <div className={cn('flex items-center', isMobile ? 'flex-wrap gap-base' : 'gap-double')}>
          <h2 className={cn('font-medium', isMobile ? 'text-xl' : 'text-2xl')}>
            {projectName}
          </h2>
          <button
            type="button"
      ...
      {kanbanViewMode === 'kanban' ? (
        visibleStatuses.length === 0 ? (
          ...
          <div className={cn('flex-1 overflow-x-auto', isMobile ? 'px-base' : 'px-double')}>
