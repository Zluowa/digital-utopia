    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            支持两种方式：使用 Anthropic 官方 API，或切换到 Claude Code 会员登录。
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          {modelConfigError && (
          ...
          {modelConfigSuccess && (
            <Alert variant="success">
              <AlertDescription>{modelConfigSuccess}</AlertDescription>
            </Alert>
          )}
          ...
          {modelConfigLoading ? (
            ...
            <>
              <div className="space-y-2">
                <Label htmlFor="model-config-base-url">API 地址</Label>
                <Input
              ...
              <div className="space-y-2">
                <Label htmlFor="model-config-api-key">API 密钥</Label>
                <Input
              ...
              <div className="space-y-2">
                <Label htmlFor="model-config-model">模型</Label>
                <Input
