...
export type DraftFollowUpData = { message: string, executor_config?: ExecutorConfig | null, executor_profile_id?: ExecutorProfileId | null, };

export type DraftWorkspaceData = { message: string, project_id: string | null, repos: Array<DraftWorkspaceRepo>, executor_config?: ExecutorConfig | null, linked_issue: DraftWorkspaceLinkedIssue | null, images?: Array<DraftWorkspaceImage>, selected_profile: ExecutorProfileId | null, };
...
export type Task = { id: string, project_id: string, title: string, description: string | null, status: TaskStatus, parent_workspace_id: string | null, created_at: string, updated_at: string, shared_task_id?: string | null, image_ids?: Array<string> | null, has_in_progress_attempt?: boolean, last_attempt_failed?: boolean, };
...
export type UpdateTask = { title?: string | null, description?: string | null, status?: TaskStatus | null, image_ids?: Array<string> | null, parent_workspace_id?: string | null, };

export type TaskWithAttemptStatus = Task & { has_in_progress_attempt?: boolean, last_attempt_failed?: boolean, parent_workspace_id?: string | null, };

export type TaskRelationships = { parent_task?: Task | null, children?: Task[], };
...
export type CreateProject = { organization_id: string, name: string, color: string, repositories?: Array<WorkspaceRepoInput>, };

export type UpdateProject = { id: string, name?: string | null, color?: string | null, sort_order?: number | null, hidden?: boolean | null, };

export type CreateProjectRepo = { repo_id: string, target_branch: string, display_name?: string | null, };
...
export type CreateFollowUpAttempt = { prompt: string, executor_config: ExecutorConfig, executor_profile_id?: ExecutorProfileId | null, retry_process_id: string | null, force_when_dirty: boolean | null, perform_git_reset: boolean | null, };
...
export type StartReviewRequest = { executor_config?: ExecutorConfig | null, executor_profile_id?: ExecutorProfileId, additional_prompt: string | null, use_all_workspace_commits: boolean, };
